...
function MultiButtons(){
    ...
    return(
        <div>
            ...
            <button id="map" onClick={handleButtonClick}>지도api</button>
            <button id="map2" onClick={handleButtonClick}>지도api</button>
            <button id="map3" onClick={handleButtonClick}>지도 검색</button>
        </div>
    );
